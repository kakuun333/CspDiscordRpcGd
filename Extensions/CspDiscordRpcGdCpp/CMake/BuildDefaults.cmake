...
function(detect_godot_platform out_platform out_arch)
    ...
    if(APPLE AND CMAKE_OSX_ARCHITECTURES)
        set(MACOS_ARCHITECTURES ${CMAKE_OSX_ARCHITECTURES})
        list(REMOVE_DUPLICATES MACOS_ARCHITECTURES)

        if("x86_64" IN_LIST MACOS_ARCHITECTURES AND "arm64" IN_LIST MACOS_ARCHITECTURES)
            set(DETECTED_ARCH "universal")
        elseif("x86_64" IN_LIST MACOS_ARCHITECTURES)
            set(DETECTED_ARCH "x86_64")
        elseif("arm64" IN_LIST MACOS_ARCHITECTURES)
